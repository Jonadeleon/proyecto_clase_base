<%@ page import="com.iesemilidarder.restaurants.web.ReadUsers" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.Iterator" %>
<%@ page import="com.iesemilidarder.restaurants.web.User" %>
    ...
    <div class="container">
        ...
        <!--BOTON PARA VER LOS USUARIOS-->
            <form class="form-inline my-2 my-lg-0" method="post" action='/users'>
                <input class="form-control mr-sm-2" type="text" placeholder="users" aria-label="users" name="users">
